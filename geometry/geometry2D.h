...
void f32_2t_add_sse3(f32_2t *dst, const f32_2t *src);

void f32_2t_sub(f32_2t *dst, const f32_2t *src);
void f32_2t_sub_sse3(f32_2t *dst, const f32_2t *src);

void f32_2t_mul(f32_2t *dst, const f32_2t *src);
void f32_2t_mul_sse3(f32_2t *dst, const f32_2t *src);

void f32_2t_div(f32_2t *dst, const f32_2t *src);
void f32_2t_div_sse3(f32_2t *dst, const f32_2t *src);

void f32_2t_mad(f32_2t *dst, const f32_2t *src1, const f32_2t *src2);
void f32_2t_mad_sse3(f32_2t *dst, const f32_2t *src1, const f32_2t *src2);

void f32_2t_smad(f32_2t *dst, const f32_2t *src1, f32_t src2);
void f32_2t_smad_sse3(f32_2t *dst, const f32_2t *src1, f32_t src2);

void f32_2t_sadd(f32_2t *dst, f32_t src);
void f32_2r_sadd_sse3(f32_2t *dst, f32_t src);

void f32_2t_ssub(f32_2t *dst, f32_t src);
void f32_2t_ssub_sse3(f32_2t *dst, f32_t src);

void f32_2t_smul(f32_2t *dst, f32_t src);
void f32_2t_ssub_sse3(f32_2t *dst, f32_t src);

void f32_2t_sdiv(f32_2t *dst, f32_t src);
void f32_2t_sdiv_sse3(f32_2t *dst, f32_t src);

f32_t f32_2t_dot(const f32_2t *src1, const f32_2t *src2);
f32_t f32_2t_dot_sse3(const f32_2t *src1, const f32_2t *src2);

// FUNCTIONS FOR OPERATING 2D FIGURES

figure32_2t* figure32_2t_copy(const figure32_2t* src);
figure32_2t* figure32_2t_copy_sse3(const figure32_2t* src);
